...
class student_Class:
    def __init__(self, root):
        ...
        Label(self.root, text="Manage Student Details", font=("goudy old style", 20, "bold"), bg='#033054', fg="white",
    ...
    def delete(self):
        ...
        try:
            if self.var_roll.get()=="":
                messagebox.showerror("Error","Roll no shold be required ",parent=self.root)
            else:
...
'''
    def get_data(self, ev):
        ...
        if len(row) >= 12:
            ...
            #self.var_roll.set("")
            #self.var_name.set("")
            messagebox.showerror("Error", "Incomplete data row")
