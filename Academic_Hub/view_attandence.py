...
class view_att_report_Class:
    def __init__(self, root):
        ...
        Label(self.root, text="view your attendance ", font=("goudy old style", 20, "bold"), bg='orange', fg="#262626",
        ...
        self.btn_clear = Button(self.root, text='Clear',command=self.clear, font=("goudy old style", 15, "bold"),
                                 bg="gray", fg="white", cursor="hand2").place(x=500, y=350, width=150, height=35)
...
if __name__ == "__main__":
    root = Tk()
    obj = view_att_report_Class(root)
    root.mainloop()
